            ...
            <div className="mx-auto max-w-screen-xl flex flex-col justify-center items-center">
                ...
                {favorites.length > 0 ? (
                    favorites.map((favorite: any, index: any) => (
                        <div key={index} className="items-center rounded-lg shadow sm:flex bg-gray-800 border-gray-700 relative mb-5">
                    ...
                    <p className="font-light text-gray-500 lg:mb-8 sm:text-xl">No hay productos favoritos</p>
                )}
