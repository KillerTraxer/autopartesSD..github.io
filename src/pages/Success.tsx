        ...
        <section>
            <div className="mx-auto max-w-screen-xl">
                <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16 justify-center items-center flex flex-col">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Compra exitosa</h2>
                    <p className="font-light text-gray-500 lg:mb-8 sm:text-xl">Tu compra se realizo de manera exitosa.</p>
                    <button
